...
%save (['\\kc.umkc.edu\kc-users\home\e\emt9q7\My Documents\MATLAB\NeuralNetsMiniProject3/SubjectIndependentNetsBONUS/NetDelay_' num2str(BestDelay) '_Node_' num2str(BestSize) '_Person_' num2str(personNum) '_fold_' num2str(crossNum) '.mat'], 'net');
...
ezroc3(Htotal);
%savefig(['\\kc.umkc.edu\kc-users\home\e\emt9q7\My Documents\MATLAB\NeuralNetsMiniProject3/6FoldROCCurvesBONUS/FigureDelay_' num2str(BestDelay) '_Node_' num2str(BestSize) '_Person_' num2str(personNum) '.fig']);
